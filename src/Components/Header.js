    ...
    return (
      ...
      <nav id="nav-wrap">
         ...
         <ul id="nav" className="nav">
            ...
            <li><a className="smoothscroll" href="#about">Rules</a></li>
	         <li><a className="smoothscroll" href="#resume">Prizes</a></li>
            {/* <li><a className="smoothscroll" href="#portfolio">Winners</a></li> */}
            <li><a className="smoothscroll" href="#contact">Sponsers</a></li>
         </ul>
      </nav>
      ...
      <p className="scrolldown">
         <a className="smoothscroll" href="#countdown"><i className="icon-down-circle"></i></a>
      </p>
